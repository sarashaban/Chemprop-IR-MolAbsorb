...
ATOM_FDIM = sum(len(choices) + 1 for choices in ATOM_FEATURES.values()) + 1 #Change
#BOND_FDIM = 14
BOND_FDIM = 7 #Change as Stero bond removed 
...
def atom_features_org(atom: Chem.rdchem.Atom, functional_groups: List[int] = None) -> List[Union[bool, int, float]]:
    """
