...
SPACE = {
    ...
    #'dropout': hp.quniform('dropout', low=0.0, high=0.20, q=0.01),
    ...
    'ffn_hidden_size': hp.quniform('ffn_hidden_size', low=1000, high=2500, q=100),
    'epochs': hp.quniform('epochs', low=200, high=400, q=50),
}
INT_KEYS = ['depth','hidden_size','ffn_num_layers','ffn_hidden_size','epochs']
